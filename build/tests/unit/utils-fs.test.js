...
describe('FS Utility', () => {
    test('should generate random file name in temp folder', () => __awaiter(void 0, void 0, void 0, function* () {
        const filepath = fsUtils.generateTempFilePath('png');
        const tmpdir = os_1.default.tmpdir();
        expect(filepath.indexOf(tmpdir) === 0).toBeTruthy();
    }));
    test('should generate random file name with specified file extension', () => __awaiter(void 0, void 0, void 0, function* () {
